...
(:action mark-done-g0
	:parameters ()
	:precondition (and (split ) (g0_at p0 c14_19))
	:effect (and (g0_done___ ))
)
(:action mark-done-g1
	:parameters ()
	:precondition (and (split ) (g1_at p0 c9_16))
	:effect (and (g1_done___ ))
)
(:action mark-done-g2
	:parameters ()
	:precondition (and (split ) (g2_at p0 c16_10))
	:effect (and (g2_done___ ))
)
(:action mark-done-g3
	:parameters ()
	:precondition (and (split ) (g3_at p0 c15_6))
...
(:action g0_move
	...
	:effect (and (not (g0_at ?x1 ?x2)) (g0_at ?x1 ?x3) (g0_free ?x2) (not (g0_free ?x3)) (increase (total-cost ) 77599.0))
)
(:action g1_move
	:parameters (?x1 - player ?x2 - cell ?x3 - cell)
	:precondition (and (g1_at ?x1 ?x2) (g1_free ?x3) (g1_connected ?x2 ?x3) (split ) (g0_done___ ))
	:effect (and (not (g1_at ?x1 ?x2)) (g1_at ?x1 ?x3) (g1_free ?x2) (not (g1_free ?x3)) (increase (total-cost ) 74526.0))
)
(:action g2_move
	:parameters (?x1 - player ?x2 - cell ?x3 - cell)
	:precondition (and (g2_at ?x1 ?x2) (g2_free ?x3) (g2_connected ?x2 ?x3) (split ) (g1_done___ ))
	:effect (and (not (g2_at ?x1 ?x2)) (g2_at ?x1 ?x3) (g2_free ?x2) (not (g2_free ?x3)) (increase (total-cost ) 244830.0))
)
(:action g3_move
	:parameters (?x1 - player ?x2 - cell ?x3 - cell)
	:precondition (and (g3_at ?x1 ?x2) (g3_free ?x3) (g3_connected ?x2 ?x3) (split ) (g2_done___ ))
	:effect (and (not (g3_at ?x1 ?x2)) (g3_at ?x1 ?x3) (g3_free ?x2) (not (g3_free ?x3)) (increase (total-cost ) 186066.0))
)
)