...
(:action mark-done-g0
	:parameters ()
	:precondition (and (split ) (g0_at c0 l3))
	:effect (and (g0_done___ ))
)
(:action mark-done-g1
	:parameters ()
	:precondition (and (split ) (g1_at c1 l1))
	:effect (and (g1_done___ ))
)
(:action mark-done-g2
	:parameters ()
	:precondition (and (split ) (g2_at c2 l6))
...
(:action mark-done-g4
	:parameters ()
	:precondition (and (split ) (g4_at c4 l1))
	:effect (and (g4_done___ ))
)
(:action mark-done-g5
	:parameters ()
	:precondition (and (split ) (g5_at c5 l3))
	:effect (and (g5_done___ ))
)
(:action mark-done-g6
	:parameters ()
	:precondition (and (split ) (g6_at c6 l6))
