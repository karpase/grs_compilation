...
(:action mark-done-g0
	:parameters ()
	:precondition (and (split ) (g0_at c3 l1))
	:effect (and (g0_done___ ))
)
(:action mark-done-g1
	:parameters ()
	:precondition (and (split ) (g1_at c0 l10))
...
(:action mark-done-g3
	:parameters ()
	:precondition (and (split ) (g3_at c4 l8))
	:effect (and (g3_done___ ))
)
(:action mark-done-g4
	:parameters ()
	:precondition (and (split ) (g4_at c1 l3))
	:effect (and (g4_done___ ))
)
(:action gGLOBAL_sail
	:parameters (?from ?to)
	:precondition (and (unsplit ) (g0_not-eq ?from ?to) (g1_not-eq ?from ?to) (g2_not-eq ?from ?to) (g3_not-eq ?from ?to) (g4_not-eq ?from ?to) (g0_location ?from) (g1_location ?from) (g2_location ?from) (g3_location ?from) (g4_location ?from) (g0_location ?to) (g1_location ?to) (g2_location ?to) (g3_location ?to) (g4_location ?to) (g0_at-ferry ?from) (g1_at-ferry ?from) (g2_at-ferry ?from) (g3_at-ferry ?from) (g4_at-ferry ?from))
	:effect (and (g0_at-ferry ?to) (g1_at-ferry ?to) (g2_at-ferry ?to) (g3_at-ferry ?to) (g4_at-ferry ?to) (not (g0_at-ferry ?from)) (not (g1_at-ferry ?from)) (not (g2_at-ferry ?from)) (not (g3_at-ferry ?from)) (not (g4_at-ferry ?from)) (increase (total-cost ) 1))
)
(:action g0_sail
	:parameters (?from ?to)
...
(:action gGLOBAL_board
	:parameters (?car ?loc)
	:precondition (and (unsplit ) (g0_car ?car) (g1_car ?car) (g2_car ?car) (g3_car ?car) (g4_car ?car) (g0_location ?loc) (g1_location ?loc) (g2_location ?loc) (g3_location ?loc) (g4_location ?loc) (g0_at ?car ?loc) (g1_at ?car ?loc) (g2_at ?car ?loc) (g3_at ?car ?loc) (g4_at ?car ?loc) (g0_at-ferry ?loc) (g1_at-ferry ?loc) (g2_at-ferry ?loc) (g3_at-ferry ?loc) (g4_at-ferry ?loc) (g0_empty-ferry ) (g1_empty-ferry ) (g2_empty-ferry ) (g3_empty-ferry ) (g4_empty-ferry ))
	:effect (and (g0_on ?car) (g1_on ?car) (g2_on ?car) (g3_on ?car) (g4_on ?car) (not (g0_at ?car ?loc)) (not (g1_at ?car ?loc)) (not (g2_at ?car ?loc)) (not (g3_at ?car ?loc)) (not (g4_at ?car ?loc)) (not (g0_empty-ferry )) (not (g1_empty-ferry )) (not (g2_empty-ferry )) (not (g3_empty-ferry )) (not (g4_empty-ferry )) (increase (total-cost ) 1))
)
(:action g0_board
	:parameters (?car ?loc)
...
(:action gGLOBAL_debark
	:parameters (?car ?loc)
	:precondition (and (unsplit ) (g0_car ?car) (g1_car ?car) (g2_car ?car) (g3_car ?car) (g4_car ?car) (g0_location ?loc) (g1_location ?loc) (g2_location ?loc) (g3_location ?loc) (g4_location ?loc) (g0_on ?car) (g1_on ?car) (g2_on ?car) (g3_on ?car) (g4_on ?car) (g0_at-ferry ?loc) (g1_at-ferry ?loc) (g2_at-ferry ?loc) (g3_at-ferry ?loc) (g4_at-ferry ?loc))
	:effect (and (g0_at ?car ?loc) (g1_at ?car ?loc) (g2_at ?car ?loc) (g3_at ?car ?loc) (g4_at ?car ?loc) (g0_empty-ferry ) (g1_empty-ferry ) (g2_empty-ferry ) (g3_empty-ferry ) (g4_empty-ferry ) (not (g0_on ?car)) (not (g1_on ?car)) (not (g2_on ?car)) (not (g3_on ?car)) (not (g4_on ?car)) (increase (total-cost ) 1))
)
(:action g0_debark
	:parameters (?car ?loc)
