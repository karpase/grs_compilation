...
(:action mark-done-g0
	:parameters ()
	:precondition (and (split ) (g0_at c3 l5))
	:effect (and (g0_done___ ))
)
(:action mark-done-g1
	:parameters ()
	:precondition (and (split ) (g1_at c2 l5))
	:effect (and (g1_done___ ))
)
(:action mark-done-g2
	:parameters ()
	:precondition (and (split ) (g2_at c4 l6))
	:effect (and (g2_done___ ))
)
(:action mark-done-g3
	:parameters ()
	:precondition (and (split ) (g3_at c1 l8))
	:effect (and (g3_done___ ))
)
(:action mark-done-g4
	:parameters ()
	:precondition (and (split ) (g4_at c0 l4))
